//_handle = [this, "Alpha"] execVM "checkCompanyStatus.sqf"; _grppatrol = _this select 0;
...
if( alive player ) then
{
	...
	if( count _Array > 0) then
	{
		...
		_handle=[_radioUnit, 1000, 50, 6000, 500, _callerTexMarker] execvm "dropSupportTeam.sqf";
	};
};